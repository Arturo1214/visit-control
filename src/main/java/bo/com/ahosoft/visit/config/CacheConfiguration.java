...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, bo.com.ahosoft.visit.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, bo.com.ahosoft.visit.repository.UserRepository.USERS_BY_EMAIL_CACHE);
