...
/**
 * REST controller for managing {@link bo.com.ahosoft.visit.domain.DocumentType}.
 */
@RestController
@RequestMapping("/api")
public class DocumentTypeResource {
    ...
    public ResponseEntity<List<DocumentType>> getAllDocumentTypes(DocumentTypeCriteria criteria, Pageable pageable) {
        log.debug("REST request to get DocumentTypes by criteria: {}", criteria);
        Page<DocumentType> page = documentTypeQueryService.findByCriteria(criteria, pageable);
