...
export class VisitorService {
  ...
  findDocumentNumber(documentNumber: string): Observable<EntityResponseType> {
    return this.http.get<IVisitor>(`${this.resourceUrl}/documentNumber/${documentNumber}`, { observe: 'response' });
  }

  findDocumentNumberAndDocumentType(documentNumber: string, documentTypeId: number): Observable<EntityResponseType> {
    return this.http.get<IVisitor>(`${this.resourceUrl}/documentNumber-type/${documentNumber}/${documentTypeId}`, { observe: 'response' });
  }
